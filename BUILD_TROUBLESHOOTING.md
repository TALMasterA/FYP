...
**Compatible versions:**
- AGP 8.1.x works with Kotlin 2.0.21
- AGP 8.2.x - 8.5.x are also compatible
- AGP 8.6.x **does not exist** (was set incorrectly)

## Gradle Wrapper Version

Current: `8.14` (in `gradle/wrapper/gradle-wrapper.properties`)

This is compatible with AGP 8.1.4. If you encounter issues, you can use:
- Gradle 8.0+ for AGP 8.1.x
- Gradle 8.1+ for AGP 8.2.x
