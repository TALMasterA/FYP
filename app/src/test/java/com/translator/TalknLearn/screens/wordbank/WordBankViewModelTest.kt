...
class WordBankViewModelTest {
    ...
    fun `account switch invalidates cached custom words count`() = runTest {
        ...
        whenever(customWordsRepo.getAllCustomWordsOnce("u1")).thenReturn(List(3) { idx ->
            com.translator.TalknLearn.model.CustomWord(id = "u1_$idx", originalWord = "o$idx", translatedWord = "t$idx")
        })
        whenever(customWordsRepo.getAllCustomWordsOnce("u2")).thenReturn(List(1) { idx ->
            com.translator.TalknLearn.model.CustomWord(id = "u2_$idx", originalWord = "o$idx", translatedWord = "t$idx")
        })
