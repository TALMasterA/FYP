...
fun HistoryContinuousTab(
    ...
    onFavouriteSession: (String, List<com.translator.TalknLearn.model.TranslationRecord>) -> Unit = { _, _ -> },
    onUnfavouriteSession: (String, List<com.translator.TalknLearn.model.TranslationRecord>) -> Unit = { _, _ -> },
    isSessionFavourited: (List<com.translator.TalknLearn.model.TranslationRecord>) -> Boolean = { false },
